...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,mDAAmD;EACnD,iCAAiC;EACjC,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,YAAY;EACZ,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,4BAA4B;AAC9B;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;AACnB;;;;AAIA;EACE,aAAa;EACb,2BAA2B;EAC3B,qCAAqC;EACrC,eAAe;EACf,YAAY;EACZ,oCAAoC;EACpC,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,qCAAqC;AACvC;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,qCAAqC;EACrC,kCAAkC;EAClC,gBAAgB;AAClB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,YAAY;EACZ,kBAAkB;EAClB,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,kBAAkB;EAClB,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;EACE,mBAAmB;EACnB,aAAa;EACb,qCAAqC;AACvC;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,kBAAkB;EAClB,iBAAiB;AACnB","sourcesContent":["body {\n  min-height: 100vh;\n  min-width: 100vw;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  align-items: center;\n  font-family: 'Roboto', Arial, Helvetica, sans-serif;\n  background-color: rgb(16, 67, 95);\n  color: white;\n}\n\n#search-input {\n  padding: 5px 10px;\n  width: 350px;\n  text-align: center;\n  border-radius: 50px;\n}\n\n#search-button {\n  cursor: pointer;\n  position: relative;\n  left: -40px;\n  border: none;\n  background: rgba(0, 0, 0, 0);\n}\n\n.radio-buttons {\n  margin-top: 10px;\n  font-size: 1.5rem;\n}\n\n\n\n.forecast-container {\n  display: grid;\n  grid-template-rows: 1fr 2fr;\n  grid-template-columns: repeat(4, 1fr);\n  min-width: 60vw;\n  height: 60vh;\n  background: rgba(255, 255, 255, 0.1);\n  border-radius: 10px;\n  padding: 10px 0;\n}\n\n.forecast-day {\n  display: grid;\n  grid-template-rows: repeat(3, 1fr);\n  grid-template-columns: repeat(4, 1fr);\n}\n\n.current-weather-temp {\n  grid-column: 2 / 3;\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: repeat(2, 1fr);\n  column-gap: 1rem;\n}\n\n#current-weather-icon {\n  grid-column: 2 / 3;\n  height: 100px;\n  width: 100px;\n  position: relative;\n  top: 10px;\n}\n\n.current-weather-degrees {\n  grid-column: 3 / 5;\n  grid-row: 1 / -1;\n  place-self: center;\n  font-size: 2.5rem;\n  font-weight: 900;\n}\n\n.current-weather-location {\n  grid-column: 3 / -1;\n  align-self: center;\n  font-size: 1.2rem;\n}\n\n.current-weather-description {\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  text-align: center;\n  font-size: 1.5rem;\n}\n\n.city-name {\n    font-size: 2.5rem;\n    font-weight: bold;\n}\n\n.forecast-days-container {\n  grid-column: 1 / -1;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n}\n\n.day {\n  grid-column: 1 / -1;\n  place-self: center;\n  font-size: 1.5rem;\n  font-weight: bold;\n}\n\n.weather-text {\n  text-align: center;\n}\n\n.img-description-container {\n  grid-column: 1 / 3;\n  place-self: center;\n  grid-row: 2 / -1;\n}\n\n.forecast-temp-container {\n  grid-row: 2 / -1;\n  grid-column: 3 / -1;\n  place-self: center;\n  font-size: 1.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
